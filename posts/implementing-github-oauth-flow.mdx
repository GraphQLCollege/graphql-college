...
# Implementing Github OAuth flow in React

![Example Github OAuth flow](/static/github-oauth.gif)
...
In order to interact with their API, you need to authenticate your users with their Github account through a mechanism called OAuth.
...
![Step three](/static/github-auth-step-3.png)
...
![Step four](/static/github-auth-step-4.png)
...
![Generated react app](/static/react-app.png)
...
![Create OAuth app](/static/register-oauth-app.png)
...
<iframe src="https://codesandbox.io/embed/nrv6k9zqxp?module=%2Fsrc%2FApp.js" className="codesandbox" sandbox="allow-modals allow-forms allow-popups allow-scripts allow-same-origin" />

## Summary

You learned how Github's OAuth flow works. You also applied that knowledge by creating a simple React app with Github authentication.
