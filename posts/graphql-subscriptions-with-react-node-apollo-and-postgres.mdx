...
<iframe src="https://codesandbox.io/embed/github/GraphQLCollege/apollo-subscriptions-example/tree/4d9c2ea9de7fdcaa482755adc25a5c5a3f0deb67/packages/client?module=%2Fsrc%2FApp.js" className="codesandbox" sandbox="allow-modals allow-forms allow-popups allow-scripts allow-same-origin"></iframe>
...
![Query example](/static/graphiql-query.gif)
...
![Mutation example](/static/graphiql-mutation.gif)
...
![Subscription example](/static/graphiql-subscription.gif)
